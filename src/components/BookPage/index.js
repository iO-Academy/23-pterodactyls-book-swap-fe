...
function BookPage() {
    ...
    function fetchBookData() {
        fetch(
            "https://2023-pterodactyl-book-api.dev.io-academy.uk/api/books/" +
                id
        )
            .then((res) => res.json())
            .then((info) => {
        ...
        <div className="bookPageContainer">
            <div className="bookpage">
                ...
                <div className="right-col">
                    ...
                    <a id="review-scores" href="#reviews">
                        {" "}
                        <u>{reviewsNum} reviews</u> - {reviewsAvg}/5 stars
                    </a>

                    {claimedBy == null ? (
                        <BookClaimForm
                            claimedBy={claimedBy}
                            setClaimedBy={setClaimedBy}
                        />
                    ) : (
                        <>
